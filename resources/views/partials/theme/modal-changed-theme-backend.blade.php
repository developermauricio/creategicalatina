<div class="modal fade text-left" id="modal-change-theme-backend" tabindex="-1" role="dialog"
     aria-labelledby="myModalLabel17" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-background-theme" >
            <div class="modal-header modal-header-background-theme">
                <h4 class="modal-title" id="myModalLabel17">{{ __('apariencia_titulo_modal') }}</h4>
            ...
            <div class="modal-body">
                <div class="row pt-1 pb-1">
                    <div class="col-12">
                        <p>{{ __('text_elige_como_se_ve') }} <img width="100" src="/images/creategica-logo.png" alt="">.
                            {{__('seleccione_tema_text')}}</p>
                    </div>
                </div>
