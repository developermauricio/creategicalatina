...
@endpush
@section('title', __('backend/provider/provider.todos_los_proveedores'))
@section('header-breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">{{ __('backend/provider/provider.proveedores') }}</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a
                                href="/{{ session('language') }}/providers">{{ __('backend/provider/provider.todos_los_proveedores') }}</a>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        $(function () {
            setTimeout(() => {
                    var table = $('.datatables-all-clients').DataTable({
                        ...
                        "ajax": {
                            url: "{{route('api.backend.all.provider')}}",
                        },
                        "columns": [
                            {"data": "id"},
                            {
                    ...
                    let text = '{{ __('backend/provider/provider.titulo_tabla') }}'
