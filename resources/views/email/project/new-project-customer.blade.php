                                ...
                                <tr>
                                    <td class="sm-px-24"
                                        ...
                                        <ul style="margin-bottom: 24px;">
                                            ...
                                            <li>
                                                <strong>{{ __('frontend/email/new-project-customer.tipo_de_proyecto') }} </strong>
                                                <p>{{ $type_project }}</p>
                                            </li>
                                            <li>
                                                <strong>{{ __('frontend/email/new-project-customer.caracteristicas') }} </strong>
                                                <p>{{ $categories_project }}</p>
                                            </li>
                                            <li>
                                                <strong>{{ __('frontend/email/new-project-customer.observación') }} </strong>
                                                <p>{{ $observation ? $observation : __('frontend/email/new-project-customer.ninguna_observacion') }}</p>
                                            </li>
                                        </ul>
                                        <table style="font-family: 'Montserrat',Arial,sans-serif;" cellpadding="0"
                                            ...
                                            <tr>
                                                <td style="mso-padding-alt: 16px 24px; --bg-opacity: 1; background-color: #F05E7D; border-radius: 4px; font-family: Montserrat, -apple-system, 'Segoe UI', sans-serif;"
                                                    ...
                                                    <a href="{{ $url_project }}"
                                                       style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; --text-opacity: 1; color: #ffffff !important;; text-decoration: none;">{{ __('frontend/email/new-project-customer.ver_proyecto') }} &rarr;</a>
                                                </td>
                                            </tr>
                                        </table>
                                        <p style="margin: 25px 0 2px; text-align: justify">
                                            {{ __('frontend/email/new-project-customer.pronto_nos_pondremos_contacto') }}
                                        </p>
