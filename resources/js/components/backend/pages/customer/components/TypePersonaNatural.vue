                            ...
                            >
                                <section style="width: 100%" v-if="currentTab===1">
                                    <h3 class="d-flex justify-content-center pb-2">
                                        {{
                                            $t('backend.customer.create-customers.titulo_wizard_datos_cliente')
                                        }}</h3>
                                    <div class="row">
                                        <div class="col-12 col-md-4 col-lg-4">
                            ...
                            <template slot="footer" slot-scope="props">
                                ...
                                <div class="wizard-footer-right">
                                    ...
                                    <wizard-button v-else @click.native="createNewCustomer()"
                                                   ...
                                                   :style="props.fillButtonStyle">
                                        {{
                                            props.isLastStep ? $t('backend.customer.create-customers.btn_titulo_wizard_create_cliente') : $t('backend.customer.create-customers.btn_titulo_wizard_siguiente')
                                        }}
                                    </wizard-button>
                                </div>
                            </template>
