<template>
    <div class="row row-item-invoice  w-100 pr-lg-0 pr-1 py-2">
        <div class="col-lg-5 col-12 mb-lg-0 mb-2 mt-lg-0 mt-2 text-input-observation">
            ...
            <!--            <textarea v-model="itemsInformationPurchaseOrder.item" class="form-control mt-2" rows="1"></textarea>-->
            <input-form
                type="textarea"
                label=""
                ...
                :required="true"
                :modelo.sync="itemsInformationPurchaseOrder.item"
                :options="{
                                                rows: 1
                                                }"
            >
        ...
        <div class="col-lg-3 col-12 my-lg-0 text-input-costo">
            ...
            <input-form
                ...
                pattern="all"
                :required="true"
                :modelo.sync="itemsInformationPurchaseOrder.price"
                :money="money"
            ></input-form>
        </div>
        <div class="col-lg-2 col-12 my-lg-0 text-input-quantity">
            ...
            <input-form
                ...
                pattern="num"
                :required="true"
                :modelo.sync="itemsInformationPurchaseOrder.quantity"
            ></input-form>
        </div>
...
export default {
    ...
    computed: {
        itemsInformationPurchaseOrder: {
            get() {
                return this.value
            },
            set(itemsInformationPurchaseOrder) {
                this.$emit('input', itemsInformationPurchaseOrder)
            }
        },

        itemsValue(){
            if(this.itemsInformationPurchaseOrder.price && this.itemsInformationPurchaseOrder.quantity){
                let value = Number(this.itemsInformationPurchaseOrder.price * this.itemsInformationPurchaseOrder.quantity)
                return isNaN(value) ? 0 : value
            }
            return isNaN(Number(this.itemsInformationPurchaseOrder.price)) ? 0 : this.itemsInformationPurchaseOrder.price
        },
