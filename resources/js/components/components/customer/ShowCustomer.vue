<template>
  <div>
    <input type="hidden" @click="onChangeInputCustomer" id="inputGetDataCustomer"/>
    <input type="hidden" @click="onChangeInputCompany" id="inputGetDataCompany"/>
            ...
            <div class="card-body">
              ...
              <div class="row pt-2">
                <div class="col-12 text-center">
                  <a :href="'/'+language+'/customer/'+slug" class="btn btn-flat-primary waves-effect">Más
                    Información</a>
                </div>
              </div>
            </div>
          ...
          <div class="card card-shadow-none card-profile img-profile-company">
            ...
            <div class="card-body">
              ...
              <div class="design-group p-1">
                <a class="avatar" style="margin-right: 0.5rem" v-if="urlFacebookCompany" :href="urlFacebookCompany"
                   target="_blank">
                  <vs-tooltip text="Facebook">
                    <img src="/images/icons-social/facebook.png" width="34" height="34" alt="Facebook">
                  </vs-tooltip>
                </a>
                <a class="avatar" style="margin-right: 0.5rem" v-if="urlInstagramCompany" :href="urlInstagramCompany"
                   target="_blank">
                  <vs-tooltip text="Instagram">
                    <img src="/images/icons-social/instagram.png" width="34" height="34" alt="Instagram">
                  </vs-tooltip>
                </a>
                <a class="avatar" style="margin-right: 0.5rem" v-if="urlSpotifyCompany" :href="urlSpotifyCompany"
                   target="_blank">
                  <vs-tooltip text="Spotify">
                    <img src="/images/icons-social/spotify.png" width="34" height="34" alt="Spotify">
                  </vs-tooltip>
                </a>
                <a class="avatar" style="margin-right: 0.5rem" v-if="urlAppleMusicCompany" :href="urlAppleMusicCompany"
                   target="_blank">
                  <vs-tooltip text="Apple Music">
                    <img src="/images/icons-social/apple-music.png" width="34" height="34" alt="Apple Music">
                  </vs-tooltip>
                </a>
                <a class="avatar" style="margin-right: 0.5rem" v-if="urlTiktokCompany" :href="urlTiktokCompany"
                   target="_blank">
                  <vs-tooltip text="TikTok">
                    <img src="/images/icons-social/tiktok.png" width="34" height="34" alt="Tiktok">
                  </vs-tooltip>
                </a>
                <a class="avatar" style="margin-right: 0.5rem" v-if="urlTwitchCompany" :href="urlTwitchCompany"
                   target="_blank">
                  <vs-tooltip text="Twitch">
                    <img src="/images/icons-social/twitch.png" width="34" height="34" alt="Twitch">
                  </vs-tooltip>
                </a>
                <a class="avatar" style="margin-right: 0.5rem" v-if="urlTwitterCompany" :href="urlTwitterCompany"
                   target="_blank">
                  <vs-tooltip text="Twitter">
                    <img src="/images/icons-social/twitter.png" width="34" height="34" alt="Twitter">
                  </vs-tooltip>
                </a>
                <a class="avatar" style="margin-right: 0.5rem" v-if="urlYoutubeCompany" :href="urlYoutubeCompany"
                   target="_blank">
                  <vs-tooltip text="YouTube">
                    <img src="/images/icons-social/youtube.png" width="34" height="34" alt="Youtube">
                  </vs-tooltip>
                </a>
                <a class="avatar" style="margin-right: 0.5rem" v-if="urlWebSiteCompany" :href="urlWebSiteCompany"
                   target="_blank">
              ...
              <div class="row pt-2">
                <div class="col-12 text-center">
                  <a :href="'/'+language+'/customer/'+slugCompany" class="btn btn-flat-primary waves-effect">Más
                    Información</a>
                </div>
              </div>
            </div>
...
export default {
  ...
  watch: {
    idCustomerProject: function (val) {
      if (val) {
        if (val.type_customer.id === 1) {
          this.idCompany = val.id
          this.getDataCompany()
        } else {
          this.idCustomer = val.id
          this.getDataCustomer()
        }
